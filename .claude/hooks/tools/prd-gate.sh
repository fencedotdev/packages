...
record_pipeline_metric() {
  ...
  # checkout even when invoked from inside a linked worktree (e.g.
  # plan-next.md's isolation:"worktree" forks) — --show-toplevel returns the
  # worktree's own path there, which sits nested under the main repo's own
  # .claude/worktrees/, breaking the "internal/ is a sibling of repo_root"
  # derivation below and silently dropping all worktree telemetry.
